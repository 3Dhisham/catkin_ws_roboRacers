...
pub_speed = rospy.Publisher("/actuators/speed", SpeedCommand, queue_size=2)
pub_steer = rospy.Publisher("/actuators/steering_normalized", NormalizedSteeringCommand, queue_size=2)
